                ...
                if(response!=null){
                    try {
                        ...
                        for(int i=0;i<json.length();i++){
                            ...
                            mangdt.add(new SanPham(object.getInt("id"),object.getString("tensp"),object.getInt("giasp"),"http://"+Server.localhost+"/source/image/product/"+object.getString("hinhanhsp"),object.getString("motasp"),object.getInt("idsp")));
